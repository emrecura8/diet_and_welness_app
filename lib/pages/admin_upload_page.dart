...
class _AdminUploadPageState extends State<AdminUploadPage> {
    ...
    try {
      ...
      final exercises = [
        ...
        },
        {
          'name': 'Jumping Jacks',
          'description':
              'A full-body aerobic exercise that increases heart rate.',
          'category': 'Cardio',
        },
        {
          'name': 'Pull-Up',
          'description':
              'An upper body exercise that targets the back and biceps.',
          'category': 'Strength',
        },
        {
      ...
      final dietPlans = [
        ...
        },
        {
          'name': 'Zone Diet',
          'description':
              'Balances protein, carbs, and fat in a 30-40-30 ratio.',
          'meals': [
            {'type': 'Breakfast', 'name': 'Eggs and fruit', 'calories': 300},
            {
              'type': 'Lunch',
              'name': 'Chicken salad with nuts',
              'calories': 400,
            },
            {
              'type': 'Dinner',
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Sample data uploaded successfully!')),
        );
      }
    } catch (e) {
      if (mounted) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Admin Bulk Upload')),
      body: Center(
        child:
            _isUploading
                ...
                : ElevatedButton.icon(
                  ...
                  label: const Text('Upload Sample Data to Firestore'),
